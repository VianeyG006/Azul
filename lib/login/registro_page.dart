...
import 'package:frame_conf/login/azul.dart';
import 'package:frame_conf/login/register_controller.dart';
  ...
  uploadTo() async {
    ...
    if (firebaseUser != null) {
      saveUserInformation(firebaseUser!).then((value) {
        ...
        Navigator.pushNamedAndRemoveUntil(context, 'hobbies', (route) => false);
